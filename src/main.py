        ...
        imported.append(
            add_expense(
                ExpenseRequest(
                    description=desc,
                    amount=amt,
                    date=row.get("date") or row.get("Date") or date.today().isoformat(),
                )
            )
        )
